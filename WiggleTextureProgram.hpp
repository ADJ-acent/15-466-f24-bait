...
struct WiggleTextureProgram {
	WiggleTextureProgram();
	~WiggleTextureProgram();
...
extern Load< WiggleTextureProgram > wiggle_texture_program;
...
extern Scene::Drawable::Pipeline wiggle_texture_program_pipeline;
