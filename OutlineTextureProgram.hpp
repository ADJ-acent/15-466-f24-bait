...
//Shader program that draws outlineformed, lit, textured vertices tinted with vertex colors:
struct OutlineTextureProgram {
...
extern Load< OutlineTextureProgram > outline_texture_program;
...
extern Scene::Drawable::Pipeline outline_texture_program_pipeline;
